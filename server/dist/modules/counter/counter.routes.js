 ...
 */
router.post('/', auth_middleware_1.authenticateAdmin, counterController.createCounter);
/**
 * @swagger
 * /api/counters:
 *   get:
 ...
 *         description: Counter not found
 */
router.put('/:id', auth_middleware_1.authenticateAdmin, counterController.updateCounter);
/**
 * @swagger
 * /api/counters/{id}:
 *   delete:
 ...
 */
router.post('/bulk-delete', auth_middleware_1.authenticateAdmin, counterController.bulkDelete);
router.delete('/:id', auth_middleware_1.authenticateAdmin, counterController.deleteCounter);
