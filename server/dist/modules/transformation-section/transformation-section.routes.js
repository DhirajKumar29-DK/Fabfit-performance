 ...
 *         description: Created
 */
router.post('/', auth_middleware_1.authenticateAdmin, transformation_section_controller_1.createSection);
/**
 * @swagger
 * /api/transformation-section/{id}:
 *   patch:
 ...
 *         description: Success
 */
router.patch('/:id', auth_middleware_1.authenticateAdmin, transformation_section_controller_1.updateSection);
/**
 * @swagger
 * /api/transformation-section/{id}:
 *   delete:
 ...
 *         description: Success
 */
router.delete('/:id', auth_middleware_1.authenticateAdmin, transformation_section_controller_1.deleteSection);
