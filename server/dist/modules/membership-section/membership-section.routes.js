 ...
 */
router.post('/', auth_middleware_1.authenticateAdmin, membership_section_controller_1.MembershipSectionController.createSection);
/**
 * @swagger
 ...
 */
router.patch('/:id', auth_middleware_1.authenticateAdmin, membership_section_controller_1.MembershipSectionController.updateSection);
/**
 * @swagger
 * /api/membership-section/{id}:
 *   delete:
 ...
 */
router.delete('/:id', auth_middleware_1.authenticateAdmin, membership_section_controller_1.MembershipSectionController.deleteSection);
