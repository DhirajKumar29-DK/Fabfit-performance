 ...
 */
router.post('/', auth_middleware_1.authenticateAdmin, program_highlight_controller_1.ProgramHighlightController.createHighlight);
/**
 * @swagger
 * /api/program-highlights:
 *   get:
 ...
 */
router.patch('/:id', auth_middleware_1.authenticateAdmin, program_highlight_controller_1.ProgramHighlightController.updateHighlight);
/**
 * @swagger
 * /api/program-highlights/{id}:
 *   delete:
 ...
 */
router.delete('/:id', auth_middleware_1.authenticateAdmin, program_highlight_controller_1.ProgramHighlightController.deleteHighlight);
