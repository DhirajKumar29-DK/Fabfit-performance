 ...
 */
router.post('/', auth_middleware_1.authenticateAdmin, program_section_controller_1.ProgramSectionController.createSection);
/**
 * @swagger
 * /api/program-section:
 *   get:
 ...
 */
router.patch('/:id', auth_middleware_1.authenticateAdmin, program_section_controller_1.ProgramSectionController.updateSection);
/**
 * @swagger
 * /api/program-section/{id}:
 *   delete:
 ...
 */
router.delete('/:id', auth_middleware_1.authenticateAdmin, program_section_controller_1.ProgramSectionController.deleteSection);
