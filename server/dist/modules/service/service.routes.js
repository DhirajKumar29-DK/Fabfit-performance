 ...
 */
router.patch('/:id', auth_middleware_1.authenticateAdmin, service_controller_1.updateService);
/**
 * @swagger
 * /api/services/{id}:
 *   delete:
 ...
 */
router.delete('/:id', auth_middleware_1.authenticateAdmin, service_controller_1.deleteService);
