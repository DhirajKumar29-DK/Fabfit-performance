 ...
 *         description: Created
 */
router.post('/', auth_middleware_1.authenticateAdmin, transformationController.createTransformation);
/**
 * @swagger
 * /api/transformations:
 *   get:
 ...
 *         description: Success
 */
router.patch('/:id', auth_middleware_1.authenticateAdmin, transformationController.updateTransformation);
/**
 * @swagger
 * /api/transformations/{id}:
 *   delete:
 ...
 *         description: Success
 */
router.delete('/:id', auth_middleware_1.authenticateAdmin, transformationController.deleteTransformation);
