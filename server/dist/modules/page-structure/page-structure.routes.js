...
const PageStructureController = __importStar(require("./page-structure.controller"));
...
router.put('/bulk-update', auth_middleware_1.authenticateAdmin, PageStructureController.bulkUpdateSections);
