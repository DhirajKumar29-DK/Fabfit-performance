 ...
 */
router.post('/', auth_middleware_1.authenticateAdmin, head_coach_controller_1.createHeadCoach);
/**
 * @swagger
 * /api/head-coach/{id}:
 *   patch:
 ...
 */
router.patch('/:id', auth_middleware_1.authenticateAdmin, head_coach_controller_1.updateHeadCoach);
/**
 * @swagger
 * /api/head-coach/{id}:
 *   delete:
 ...
 */
router.delete('/:id', auth_middleware_1.authenticateAdmin, head_coach_controller_1.deleteHeadCoach);
