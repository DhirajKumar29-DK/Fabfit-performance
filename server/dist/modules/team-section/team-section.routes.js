 ...
 */
router.post('/', auth_middleware_1.authenticateAdmin, team_section_controller_1.createTeamSection);
/**
 * @swagger
 * /api/team-section/{id}:
 *   patch:
 ...
 */
router.patch('/:id', auth_middleware_1.authenticateAdmin, team_section_controller_1.updateTeamSection);
/**
 * @swagger
 * /api/team-section/{id}:
 *   delete:
 ...
 */
router.delete('/:id', auth_middleware_1.authenticateAdmin, team_section_controller_1.deleteTeamSection);
