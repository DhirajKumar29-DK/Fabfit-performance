 ...
 */
router.post('/', auth_middleware_1.authenticateAdmin, hero_controller_1.HeroController.createHero);
/**
 * @swagger
 * /api/heroes:
 *   get:
 ...
 */
router.post('/bulk-delete', auth_middleware_1.authenticateAdmin, hero_controller_1.HeroController.bulkDeleteHeroes);
/**
 * @swagger
 * /api/heroes/{id}:
 *   get:
 ...
 */
router.patch('/:id', auth_middleware_1.authenticateAdmin, hero_controller_1.HeroController.updateHero);
/**
 * @swagger
 * /api/heroes/{id}:
 *   delete:
 ...
 */
router.delete('/:id', auth_middleware_1.authenticateAdmin, hero_controller_1.HeroController.deleteHero);
