 ...
 */
router.post('/', auth_middleware_1.authenticateAdmin, team_member_controller_1.createTeamMember);
/**
 * @swagger
 * /api/team-members/{id}:
 *   patch:
 ...
 */
router.patch('/:id', auth_middleware_1.authenticateAdmin, team_member_controller_1.updateTeamMember);
/**
 * @swagger
 * /api/team-members/{id}:
 *   delete:
 ...
 */
router.delete('/:id', auth_middleware_1.authenticateAdmin, team_member_controller_1.deleteTeamMember);
